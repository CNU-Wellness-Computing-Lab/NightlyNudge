...
//        long totalUsageTime =  30l * 60 + 45; //test
//        long usageTimeInSleepTime = 0l * 60; // test
...
//                    Log.d("TEST", "current time : " + currentDateTime/ (60 * 60 * 1000) % 24 + ":" + currentDateTime /  (60 * 1000) % 60 + ":" + currentDateTime /  (1000) % 60);
         ...
         * @return                  배터리의 잔량
         */
        private int calcBattCapacity(long _usageTimeInSleepTime, long _totalSleepTime, String _status){
            // 기울기 구하기
            // 기울기 = 100 / 전체 수면 시간 (소수)
